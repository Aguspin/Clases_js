class Alumno {
    ...
    calcularPromedio(materias) {
        ...
        for(let materia of materias) {
            promedio += this.calificaciones[materia];// Obtiene el valor de cada propiedad en calificaciones 
        }
        this.promedio = promedio / materias.length;//acabamos de modificar el valor de promedio desde la propia clase 
        this.guardarEstatus();
    }
